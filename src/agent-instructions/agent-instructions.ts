...
export const ABCM_AGENT_INSTRUCTIONS_VERSION = "1.18.1" as const;
...
- MCP initialize.serverInfo.version — версия пакета/сервера, а версия этой инструкции — версия эксплуатационного контракта. После изменения любой из них или серверной конфигурации переподключите connector/tunnel, заново получите tools/list и не используйте закэшированный manifest. Полный настроенный контур сервера 0.1.1 с инструкцией 1.18.1 содержит 42 операции; отсутствие условных business-evaluation, task-success или documentation-source операций означает, что оператор не включил соответствующую конфигурацию.
