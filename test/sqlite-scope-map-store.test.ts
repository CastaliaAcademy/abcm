...
describe("SqliteScopeMapStore", () => {
  ...
  test("upgrades schema v1 to v10 transactionally", () => {
  ...
  test("upgrades schema v2 to v10 without replacing the active revision", () => {
    const initial = new SqliteScopeMapStore(databasePath);
    const lease = initial.beginScan("workspace");
  ...
  test("upgrades schema v3 to v10 without replacing the active revision", () => {
    const initial = new SqliteScopeMapStore(databasePath);
    const lease = initial.beginScan("workspace");
  ...
  test("upgrades schema v4 to v10 and normalizes graph metadata without replacing the active revision", () => {
    const initial = new SqliteScopeMapStore(databasePath);
  ...
  test("upgrades schema v5 to v10 with durable sync, cutover journals, and context catalog", () => {
    const initial = new SqliteScopeMapStore(databasePath);
    initial.close();
    const legacy = new Database(databasePath);
  ...
  test("upgrades schema v6 to v10 without replacing the active revision", () => {
    const initial = new SqliteScopeMapStore(databasePath);
    const lease = initial.beginScan("workspace");
  ...
  test("upgrades schema v7 to v10 with optional worker metadata and keeps the active revision", () => {
    const initial = new SqliteScopeMapStore(databasePath);
  ...
  test("upgrades schema v8 to v10 with immutable context outcomes", () => {
    const initial = new SqliteScopeMapStore(databasePath);
    initial.close();
    const legacy = new Database(databasePath);
  ...
  test("upgrades schema v9 to v10 with versioned context cache and feedback proposals", () => {
    const initial = new SqliteScopeMapStore(databasePath);
    initial.close();
    const legacy = new Database(databasePath);
