...
describe("OpenAPI contract", () => {
  test("is generated deterministically from shared schemas", () => {
    ...
    expect(document.components.schemas).toEqual(expect.objectContaining({
      ...
      ContextFeedbackSubmission: expect.objectContaining({ additionalProperties: false }),
      ContextFeedbackProposal: expect.objectContaining({ additionalProperties: false }),
      ContextFeedbackListResult: expect.objectContaining({ additionalProperties: false }),
      BusinessEvaluationRunRequest: expect.objectContaining({ additionalProperties: false }),
      BusinessEvaluationReceipt: expect.objectContaining({ additionalProperties: false }),
      BusinessEvaluationListResult: expect.objectContaining({ additionalProperties: false }),
      BusinessEvaluationProfileListResult: expect.objectContaining({ additionalProperties: false }),
      TaskSuccessStartRequest: expect.objectContaining({ additionalProperties: false }),
      TaskSuccessSession: expect.objectContaining({ additionalProperties: false }),
      TaskSuccessClaimRequest: expect.objectContaining({ additionalProperties: false }),
      TaskSuccessClaimResult: expect.objectContaining({ additionalProperties: false }),
      TaskSuccessSubmitRequest: expect.objectContaining({ additionalProperties: false }),
