...
Status: complete for local 0.1.0 release candidate
...
- [x] Eighteen final release documents are published and reread byte-for-byte through the authenticated ABCM REST workspace; the post-publication scan has zero diagnostics.
